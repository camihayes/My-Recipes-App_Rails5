...
class ChefTest < ActiveSupport::TestCase
  def setup
   @chef = Chef.new(chefname: "cami", email: "cami@example.com",
  ...
  test "email should accept correct format" do
    valid_emails = %w[user@example.com CAMI@gmail.com M.first@yahoo.ca john+smith@co.uk.org]
  ...
  test "should reject invalid addresses" do
    invalid_emails = %w[cami@example cami@example,com cami.name@gmail. joe@bar+foo.com]
